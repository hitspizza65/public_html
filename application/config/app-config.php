...
*
*/
define('APP_BASE_URL', 'https://macidcasting.com/');
...
*/
define('APP_ENC_KEY', '501ef71491b951054142a17e7d35970e');
 ...
 */
define('APP_DB_USERNAME', 'macidcas_crm');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', '$6[FJYm7YCq.');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'macidcas_crm');
